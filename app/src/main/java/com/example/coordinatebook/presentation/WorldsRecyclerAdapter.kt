...
class WorldsRecyclerAdapter(val worlds: MutableList<WorldInfo>): RecyclerView.Adapter<WorldsRecyclerAdapter.WorldHolder>() {
    class WorldHolder(view: View): RecyclerView.ViewHolder(view) {
